...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title><?php $_SESSION['user_role'] ?> Profile</title>
          ...
          <div class="row col col-md-6">
            ...
            <div class="row col col-md-12 m-auto" id="edit">
              ...
              <div id="edit_button" class="col col-md-4 form-group float-right">
                <button class="btn btn-primary form-control font-weight-bold" onclick="edit(true);">Edit</button>
              </div>
            ...
            <div class="row col col-md-12 m-auto" id="update_cancel" style="display: none;">
              ...
              <div id="cancel_button" class="col col-md-4 form-group float-right">
                <button class="btn btn-danger form-control font-weight-bold" onclick="edit(false);">CANCEL</button>
              </div>
