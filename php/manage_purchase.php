<?php
  ...
  function showPurchases($id) {
    ...
    if($con) {
      ...
      $sql_qry = "SELECT count(VOUCHER_NUMBER) FROM purchases";
      ...
      $query = "SELECT * FROM purchases limit $start, $limit";
      $result = mysqli_query($con, $query);
    ...
    <div class="col-md-10">
        <nav aria-label="Page navigation">
          <ul class="pagination pagination-sm">
            <li>
              <a href="./manage_purchase.php?page=<?= $previous; ?>" aria-label="Previous">
                <span aria-hidden="true">&laquo; Previous</span>
              </a>
            </li>
            <?php for ($i=1; $i <= $pages; $i++) : ?>
              <li><a href="./manage_purchase.php?page=<?= $i; ?>" ><?= $i; ?></a></li>
            <?php endfor; ?>
            <li>
              <a href="./manage_purchase.php?page=<?= $next; ?>" aria-label="Next">
