<?php
  ...
  function addSale() {
    ...
    require "db_connection.php";
    if($con) {
      $query = "INSERT INTO sales (INVOICE_NUMBER, MEDICINE_NAME, BATCH_ID, EXPIRY_DATE, QUANTITY, MRP, DISCOUNT, TOTAL) VALUES($invoice_number, '$medicine_name', '$batch_id', '$expiry_date', $quantity, $mrp, $discount, $total)";
      $result = mysqli_query($con, $query);
  ...
  function addNewInvoice() {
    ...
    require "db_connection.php";
    if($con) {
      $query = "INSERT INTO invoices (INVOICE_DATE, TOTAL_AMOUNT, TOTAL_DISCOUNT, NET_TOTAL) VALUES('$invoice_date', $total_amount, $total_discount, $net_total)";
      $result = mysqli_query($con, $query);
