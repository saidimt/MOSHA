<?php
  ...
  function showMedicines($id) {
    ...
    if($con) {
      ...
      $sql_qry = "SELECT count(ID) FROM medicines";
      ...
      $query = "SELECT * FROM medicines limit $start, $limit";
      $result = mysqli_query($con, $query);
    ...
    <div class="col-md-10">
        <nav aria-label="Page navigation">
          <ul class="pagination pagination-sm">
            <li>
              <a href="./manage_medicine.php?page=<?= $previous; ?>" aria-label="Previous">
                <span aria-hidden="true">&laquo; Previous</span>
              </a>
            </li>
            <?php for ($i=1; $i <= $pages; $i++) : ?>
              <li><a href="./manage_medicine.php?page=<?= $i; ?>" ><?= $i; ?></a></li>
            <?php endfor; ?>
            <li>
              <a href="./manage_medicine.php?page=<?= $next; ?>" aria-label="Next">
