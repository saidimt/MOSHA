...
function updateAdminDetails() {
  ...
  if(!validateName(pharmacy_name.value, 'pharmacy_name_error'))
    ...
    if(validatePassword(password)) {
      ...
      xhttp.open("GET", "php/validateCredentials.php?action=update_admin_info&pharmacy_name=" + pharmacy_name.value + "&address=" + address.value + "&email=" + email.value + "&contact_number=" + contact_number.value, true);
      xhttp.send();
      edit(true);
      return true;
    }
