      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              ...
              <select id="payment_type" name="paytype" class="form-control">
                ...
                <option value="Payment Due" disabled>Payment Due</option>
              </select>
            </div>
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="upload">Upload CSV :</label>
              &emsp;<button id="upload" class="btn btn-success font-weight-bold" onclick="">Upload CSV</button>
            </div>
          ...
          <div class="row col col-md-12 font-weight-bold">
            ...
            <div class="col col-md-1">Exp.Date (mm/yy)</div>
            <div class="col col-md-1">Quantity</div>
            <div class="col col-md-1">Sell Price(MRP)</div>
            <div class="col col-md-1">Buy Price(Rate)</div>
